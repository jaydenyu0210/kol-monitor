...
async def run():
    ...
    async with async_playwright() as p:
        ...
        await page.goto('https://x.com/tussiwe', wait_until="domcontentloaded", timeout=60000)
        await asyncio.sleep(8)
        
        await page.screenshot(path='/data/.openclaw/workspace/kol-monitor/test_twitter2.png')
        await browser.close()
